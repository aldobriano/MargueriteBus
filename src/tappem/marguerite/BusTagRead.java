...
public class BusTagRead extends Activity {
...
//			mifare.connect();
//			System.out.println(mifare.authenticateSectorWithKeyA(0, MifareClassic.KEY_MIFARE_APPLICATION_DIRECTORY));
//			byte[] block0 = mifare.readBlock(0);
//			int type = mifare.getType();
//			mifare.close();
			
//			System.out.println(asHex(block0));
//			System.out.println("TYPE " + type);
	        ...
	        i.putExtra(MargueriteTransportation.TAG_ID, tagId);
	        startActivity(i);
